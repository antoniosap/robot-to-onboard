 ...
 *                        process 3. rostopic pub base/wheel_lv std_msgs/Int16 20 --once
 *                        process 4. rostopic list
 * NOTES ON USAGE ON RPI: process 1. roscore
 *                        process 2. rosrun rosserial_python serial_node.py _port:=/dev/ttyACM0 _baud:=115200
 *                        process 3. rostopic pub base/wheel_lv std_msgs/Int16 20 --once
 *                                   rostopic pub base/wheel_lv std_msgs/Int16 --once -- -20
 *                                   rostopic pub base/wheel_lv std_msgs/Int16 --once -- +20
 *                        process 4. rostopic list
 *                        oppure con launch
 *                        
 * SUL CLIENT REMOTO:     export ROS_HOSTNAME=saturn
 *                        export ROS_MASTER_URI=http://rosrobot:11311
 *                        rostopic list
 * 
 * IMPORTANTE:  --->      TCP/IP STATICI e definiti nel file /etc/hosts in ogni nodo locale e remoto
 ...
 * 
 * DISPLAY:               conda activate ros-env
 *                        rqt_plot base/lwheel
 * 
...
void ledGotoState(byte n, int delayms) {
